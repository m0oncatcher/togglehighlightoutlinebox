...
public class FabricLibClientMod implements ClientModInitializer {
    ...
    private static final KeyMapping.Category TOGGLE_HIGHLIGHT_CATEGORY =
            new KeyMapping.Category(Identifier.fromNamespaceAndPath(CommonMod.MOD_ID, "binds"));
